...
public class Main_BJ_2527_직사각형_2 {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < tc_n; i++) {
			...
			if(square_1[0].equals(square_2[2]) ||
				...
				sb.append("d\n");
			} else if((square_1[2].y == square_2[0].y &&
					((square_1[3].x < square_2[0].x && square_2[0].x < square_1[2].x) ||
							(square_2[0].x < square_1[2].x && square_1[2].x < square_2[1].x))) || 
					
					(square_1[0].y == square_2[2].y && 
					((square_1[0].x < square_2[2].x && square_2[2].x < square_1[1].x) || 
							(square_2[3].x < square_1[0].x && square_1[0].x < square_2[2].x))) ||
					
					(square_1[2].x == square_2[0].x && 
					((square_1[1].y < square_2[0].y && square_2[0].y < square_1[2].y) ||
							(square_2[0].y < square_1[2].y && square_1[2].y < square_2[3].y)))||
					
					(square_1[0].x == square_2[2].x && 
					((square_1[0].y < square_2[2].y && square_2[2].y < square_1[3].y)||
					(square_2[1].y < square_1[0].y && square_1[0].y < square_2[2].y)))) {
				sb.append("b\n");
			} else {
				sb.append("a\n");
			}
